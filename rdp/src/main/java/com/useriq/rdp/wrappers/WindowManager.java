package com.useriq.rdp.wrappers;
...
public final class WindowManager {
    ...
    public void rotate(int rotation) {
        try {
            Class<?> cls = manager.getClass();
            Method freezeRotation = cls.getMethod("freezeRotation", int.class);
            freezeRotation.invoke(manager, rotation);
        } catch (Exception e) {
            throw new AssertionError(e);
        }
    }
    ...
    /**
     * thawRotation will unfreeze the rotation ie will enable
     * "rotate screen automatically"
     */
    public void thawRotation() {
        try {
            Class<?> cls = manager.getClass();
            Method thawRotation = cls.getMethod("thawRotation");
            thawRotation.invoke(manager);
        } catch (Exception e) {
            throw new AssertionError(e);
        }
    }
