...
public class StickyScrollView extends ScrollView {
    ...
    protected View getCurrentlyStickingView() {
        return currentlyStickingView;
    }


    protected void enableStickyView(final boolean enabled) {
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		if(currentlyStickingView != null && enabled){
			canvas.save();
	...
	protected void startStickingView(View viewThatShouldStick) {
	...
	protected void stopStickingCurrentlyStickingView() {
		if(getStringTagForView(currentlyStickingView).contains(FLAG_HASTRANSPARANCY)){
			showView(currentlyStickingView);
		}
